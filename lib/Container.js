...
Container.prototype.get = function get(id) {
    // Reset the previously observed services - this is meant to prevent circular
    // dependencies
...
Container.prototype.constructService = function constructService(id, isOptional, serviceTree, ns) {
    ...
    } else if (definition.isFactoryFunction) {
        svc = definition.class.apply(this, arguments);
    } else {
